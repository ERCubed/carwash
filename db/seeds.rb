vehicle_type_1 = VehicleType.create(name: 'Car', price: 7.50)
vehicle_type_2 = VehicleType.create(name: 'Truck', price: 12.00)
vehicle_type_3 = VehicleType.create(name: 'SUV', price: 15.00)
...
vehicle_truck = Vehicle.create(vehicle_type_id: vehicle_type_2.id, color: 'white', year: '2015',
  make: 'Ford', model: 'F-150', license_plate: 'DV15J6')
